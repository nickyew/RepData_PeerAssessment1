...
```{r histogram of steps per day - 1}
...
```{r histogram of steps per day - 2}
...
```
**Mean Steps:** `r as.character(Mean_Steps)`  
**Median Steps:** `r as.character(Median_Steps)`
...
**New Mean Steps:** `r as.character(Mean_StepsNew)`  
**New Median Steps:** `r as.character(Median_StepsNew)`

Steps Type    | Original                       | With Imputed Values                | Percentage Change 
------------- | ----------------               | --------------------               | ----------
Mean Steps    | `r as.character(Mean_Steps)`   | `r as.character(Mean_StepsNew)`    | `r meanchange`% 
Median Steps  | `r as.character(Median_Steps)` | `r as.character(Median_StepsNew)`  | `r medianchange`%
...
plot(dfwd$interval, dfwd$mean, type="l", col = "red", xlab = "Interval", ylab = "Mean Steps")
plot(dfwe$interval, dfwe$mean, type="l", col = "blue", xlab = "Interval", ylab = "Mean Steps")
